...
Note: remove <div class="centroassoluto"> before adding to your page
*/}
  <link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet" />
  <div className="centroassoluto">
    <div className="ftC">
      <p className="sparisci">Responsive Contact Footer. Breakpoint at minimum width 768px</p>
      <p className="sparisci2">Responsive Contact Footer. Breakpoint at maximum width 768px</p>
      <div className="orizcontatti">
        <div className="colonnacontatti">
          <a href="mailto:yourname@yourdomain.com">
            <svg className="iconacontatti" version="1.1" id="play" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="40px" width="40px" viewBox="0 0 40 40" enableBackground="new 0 0 40 40" xmlSpace="preserve">
              <circle className="stroke-under" fill="none" stroke="#808080" cx={20} cy="20.1" r="19.3" />
              <path className="stroke-solid" fill="none" stroke="#dcdcdc" d="M39.3,20.1c0,10.7-8.7,19.3-19.3,19.3S0.7,30.7,0.7,20.1" />
              <path className="stroke-solid" fill="none" stroke="#dcdcdc" d="M0.7,20.1C0.7,9.4,9.3,0.7,20,0.7s19.3,8.7,19.3,19.3" />
              <g className="st0">
                <g>
          ...
          <p>COMPANY MAIL</p>
          <p><a href="mailto:yourname@yourdomain.com" style={{fontWeight: 'normal'}}>yourname@yourdomain.com</a></p>
        </div>
        <div className="vl" /><div className="ol" />
        <div className="colonnacontatti"><center>
            <svg className="iconacontatti" version="1.1" id="play" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="40px" width="40px" viewBox="0 0 40 40" enableBackground="new 0 0 40 40" xmlSpace="preserve">
              <circle className="stroke-under" fill="none" stroke="#808080" cx={20} cy="20.1" r="19.3" />
              <path className="stroke-solid" fill="none" stroke="#dcdcdc" d="M39.3,20.1c0,10.7-8.7,19.3-19.3,19.3S0.7,30.7,0.7,20.1" />
              <path className="stroke-solid" fill="none" stroke="#dcdcdc" d="M0.7,20.1C0.7,9.4,9.3,0.7,20,0.7s19.3,8.7,19.3,19.3" />
        ...
        <div className="vl" /><div className="ol" />
        <div className="colonnacontatti">
          <a className="iconacontatti" href="https://www.google.it/maps/place/Sushi+Design+Studio/@45.4313977,12.3192803,17z/data=!3m1!4b1!4m5!3m4!1s0x477eb1d8ae53fdaf:0x1c923f25ffddd403!8m2!3d45.431394!4d12.321469?hl=it">
            <svg version="1.1" id="play" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="40px" width="40px" viewBox="0 0 40 40" enableBackground="new 0 0 40 40" xmlSpace="preserve">
              <circle className="stroke-under" fill="none" stroke="#808080" cx={20} cy="20.1" r="19.3" />
              <path className="stroke-solid" fill="none" stroke="#dcdcdc" d="M39.3,20.1c0,10.7-8.7,19.3-19.3,19.3S0.7,30.7,0.7,20.1" />
              <path className="stroke-solid" fill="none" stroke="#dcdcdc" d="M0.7,20.1C0.7,9.4,9.3,0.7,20,0.7s19.3,8.7,19.3,19.3" />
              <g className="st0">
